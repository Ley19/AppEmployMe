...
public class NotasListaAdapter extends RecyclerView.Adapter<NotasViewHolder>{
    ...
    private int getRandomColor(){
        ...
        CodigoColores.add(R.color.CC_azulito);
        CodigoColores.add(R.color.CC_azulito2);
        CodigoColores.add(R.color.CC_rojito);
        CodigoColores.add(R.color.CC_moradio);
        CodigoColores.add(R.color.CC_rosita);
        CodigoColores.add(R.color.CC_cafesito);
        CodigoColores.add(R.color.CC_huesito);
        CodigoColores.add(R.color.CC_grisesito);
